...
$text_panel_admin_login_template = <<<HTML
🛡️ <b>پنل مدیریت</b>
• نسخه ربات: <b>%s</b>
• نسخه مینی‌اپ: <b>%s</b>

به منوی زیر دسترسی دارید. در صورت نیاز، متن این بخش را می‌توانید مستقیماً در فایل <code>admin.php</code> ویرایش کنید.
HTML;
...
// فقط پیام بدون هیچ دکمه‌ای
sendmessage(
    $from_id,
    "📌 جهت ورود به پنل تحت وب نیاز است حتماً آیپی خود را ثبت کنید.\nلطفاً آیپی ثابت خود را ارسال نمایید.",
    null,
    'HTML'
);
...
// بعد از ثبت آیپی فقط پیام تایید، بدون دکمه
sendmessage(
    $from_id,
    "✅ آیپی با موفقیت تنظیم شد",
    null,
    'HTML'
);
